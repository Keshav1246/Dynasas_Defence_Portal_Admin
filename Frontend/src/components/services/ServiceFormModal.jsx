...
import { X, Image as ImageIcon, UploadCloud, Video, Box, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
            ...
            <div className={activeTab === 'settings' ? 'block' : 'hidden'}>
              <div className="space-y-4 pb-32">
                <div>
                  ...
                  {/* Hidden input to ensure react-hook-form tracks the value if needed */}
        ...
        {/* Footer */}
        <div className="flex items-center justify-end px-6 py-4 border-t border-gray-100 gap-3 rounded-b-2xl bg-gray-50/50">
          <button
            type="button"
            onClick={onClose}
