...
const ContactInquirySection = ({ data, forwardRef }) => {
  const defaults = CONTACT_PAGE_DEFAULTS;
          ...
          <div className="w-full lg:w-[65%] border border-[rgba(255,255,255,0.06)] bg-[#080808] p-8 md:p-12 relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-4">
                <span className="text-[10px] text-brand-primary tracking-widest font-heading uppercase font-bold">SEND US AN INQUIRY</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-brand-white leading-tight mb-4">
                {defaults.inquiry.title}
              </h2>
              <p className="text-brand-white/50 font-body mb-10">
                {defaults.inquiry.description}
              </p>
              ...
              <AnimatePresence mode="wait">
                {isSuccess ? (
                  ...
                  >
                    ...
                    <p className="text-brand-white/70 font-body">Our team will contact you shortly.</p>
                  </motion.div>
                ) : (
                  <motion.form 
                    initial={{ opacity: 0 }}
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <label className="text-sm font-heading font-bold text-brand-white uppercase tracking-wider">Full Name <span className="text-brand-primary">*</span></label>
                        <input 
                          type="text" 
                          name="fullName"
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-heading font-bold text-brand-white uppercase tracking-wider">Organization</label>
                        <input 
                          type="text" 
                          name="organization"
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-heading font-bold text-brand-white uppercase tracking-wider">Email Address <span className="text-brand-primary">*</span></label>
                        <input 
                          type="email" 
                          name="email"
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-heading font-bold text-brand-white uppercase tracking-wider">Phone Number</label>
                        <input 
                          type="tel" 
                          name="phone"
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-heading font-bold text-brand-white uppercase tracking-wider">Inquiry Type <span className="text-brand-primary">*</span></label>
                      <select 
                        name="inquiryType"
                      ...
                      >
                        ...
                        {defaults.inquiry.types.map((type, idx) => (
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-heading font-bold text-brand-white uppercase tracking-wider">Your Message <span className="text-brand-primary">*</span></label>
                      <textarea 
                        name="message"
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-4 border-t border-[rgba(255,255,255,0.06)]">
                      ...
                      <div className="flex items-center gap-3 text-brand-white/40 text-xs">
                        ...
                        <span>Your information is secure and<br/>will never be shared.</span>
                      </div>
                    </div>
                  </motion.form>
                )}
            ...
            <div className="border border-[rgba(255,255,255,0.06)] bg-[#050505] h-full flex flex-col relative overflow-hidden group">
              ...
              <div className="p-8 md:p-10 flex-1 flex flex-col relative z-10 -mt-20">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <span className="text-[10px] text-brand-white/80 tracking-widest font-heading uppercase font-bold">{defaults.support.label}</span>
                </div>
                
                <h3 className="text-3xl font-heading font-bold text-brand-white leading-tight mb-4 drop-shadow-md">
                  {defaults.support.heading}<br/>
                  <span className="text-brand-primary">{defaults.support.headingHighlight}</span>
                </h3>
                
                <p className="text-sm text-brand-white/60 font-body leading-relaxed mb-10">
                  {defaults.support.description}
                </p>
                ...
                <div className="space-y-4 mt-auto">
                  ...
                  <div className="flex items-center gap-4 p-5 border border-brand-primary/20 bg-brand-primary/5 group/card hover:bg-brand-primary/10 transition-colors rounded-sm">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-mono text-brand-primary drop-shadow-[0_0_5px_rgba(255,106,0,0.5)]">{data?.defenseContractsPhone || defaults.info.defenseContractsPhone}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-5 border border-brand-primary/20 bg-brand-primary/5 group/card hover:bg-brand-primary/10 transition-colors rounded-sm">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-mono text-brand-primary drop-shadow-[0_0_5px_rgba(255,106,0,0.5)]">{data?.securityEmail || defaults.info.securityEmail}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-5 border border-brand-primary/20 bg-brand-primary/5 group/card hover:bg-brand-primary/10 transition-colors rounded-sm">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-mono text-brand-primary drop-shadow-[0_0_5px_rgba(255,106,0,0.5)]">{defaults.support.responseTime}</p>
                    </div>
                  </div>
